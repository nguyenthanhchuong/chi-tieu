...
function moHopSua(id) {
  ...
  // Chuyển lọ và vay nợ không có danh mục để chọn, chỉ sửa được số tiền và
  // ghi chú. Không khoá lại thì danh mục sẽ bị thay bằng "Ăn uống" và khoản
  // cho vay biến thành khoản chi ngay trong lần lưu kế tiếp.
